...
// ─── domain row types ───
export type User = { id: string; address: string; name: string; verified: boolean; humanId?: string; avatar?: string; bio?: string; country?: string; createdAt: number; arcTx?: string };
